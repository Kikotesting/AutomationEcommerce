...
/**
     ...
     * @param browser - the driver instance
     *//*

    public void get(String url, WebDriver browser) {
        get(url, browser, TIMEOUT);
    }
...
/**
     ...
     * @param url              - the url to open in the browser
     * @param browser           - the driver instance
     * @param specifiedTimeout specifiedTimeout - number of seconds to wait for
     *//*

    public void get(String url, WebDriver browser, int specifiedTimeout) {
        browser.get(url);
        waitForPageLoadComplete(browser, specifiedTimeout);
    }
...
/**
    ...
    public void getAndWaitForElementToBeDisplayed(String url, WebElement element, WebDriver browser) {
        getAndWaitForElementToBeDisplayed(url, element, browser, TIMEOUT);
    }
...
/**
    ...
    public void getAndWaitForElementToBeDisplayed(String url, WebElement element, WebDriver browser, int
            specifiedTimeout) {
        get(url, browser, specifiedTimeout);
        waitForElementToBeDisplayed(element, browser, specifiedTimeout);
    }
...
/**
    ...
    public void getUrlAndWaitForUrl(String urlToGet, String urlToWaitFor, WebDriver browser) {
        getUrlAndWaitForUrl(urlToGet, urlToWaitFor, browser, TIMEOUT);
    }
...
/**
    ...
    public void getUrlAndWaitForUrl(String urlToGet, String urlToWaitFor, WebDriver browser, int specifiedTimeout) {
        driver.get(urlToGet);
        waitForUrl(urlToWaitFor, browser, specifiedTimeout);
    }
...
*/
/*    public void waitForPageLoadComplete(WebDriver browser, int specifiedTimeout) {
        Wait<WebDriver> wait = new WebDriverWait(browser, specifiedTimeout);
        wait.until(browser1 -> String
                .valueOf(((JavascriptExecutor) browser1).executeScript("return document.readyState"))
                .equals("complete"));
    }*//*
...
/**
    ...
    public void waitForElementToBeDisplayed(WebElement element, WebDriver browser) {
        waitForElementToBeDisplayed(element, browser, TIMEOUT);
    }
